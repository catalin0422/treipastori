      ...
      <div className="hero-content">
        ...
        <div className="hero-amenities">
          {[
            ...
            { label: "Pescuit", icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" width="28" height="28"><path d="M20 12c0-3.5-3-6-8-6S4 8.5 4 12s3 6 8 6 8-2.5 8-6z"/><path d="M20 12l3.5-4v8L20 12z"/><circle cx="8.5" cy="10.5" r="1.2" fill="currentColor" stroke="none"/></svg> },
